...
def application(request):
	...
	try:	
		if int(age)<18:
			...
			info=("Loan Accepted")
		elif (major == "philosophy" and salery>1000000000) or (major == "Philosophy" and salery>1000000000):
			info=("I don't thing your going to make " + str(salery) + " dollers with a philosophy major")
